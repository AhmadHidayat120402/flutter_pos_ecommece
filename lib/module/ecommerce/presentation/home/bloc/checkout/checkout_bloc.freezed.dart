...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'CheckoutState.loaded(products: $products, discount: $discount, addressId: $addressId, paymentMethod: $paymentMethod, shippingService: $shippingService, shippingCost: $shippingCost, paymentVaName: $paymentVaName)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(products, discount, addressId, paymentMethod, shippingService,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(products, discount, addressId, paymentMethod,
        shippingService, shippingCost, paymentVaName);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (loaded != null) {
      return loaded(products, discount, addressId, paymentMethod,
          shippingService, shippingCost, paymentVaName);
    }
    return orElse();
  }
