...
class _$DoOrderImpl implements _DoOrder {
  ...
  @override
  String toString() {
    return 'OrderEvent.doOrder(addressId: $addressId, discount: $discount, paymentMethod: $paymentMethod, shippingService: $shippingService, shippingCost: $shippingCost, paymentVaName: $paymentVaName, products: $products)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return doOrder(addressId, discount, paymentMethod, shippingService,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return doOrder?.call(addressId, discount, paymentMethod, shippingService,
        shippingCost, paymentVaName, products);
  }
